<%@ page contentType="text/html; charset=UTF-8" %>
    ...
    <nav class="left-nav">
        <ul id="js-menu" class="menu">
            ...
            <li class="menu--item">
                <a href="#" class="menu--link" title="주문 / 배송 관리">
            ...
            <li class="menu--item menu--item__has_sub_menu">
                ...
                <ul class="sub_menu">
                    <li class="sub_menu--item">
                        <a href="#" class="sub_menu--link">상품 관리</a>
                    </li>
                    <li class="sub_menu--item">
            ...
            <li class="menu--item">
                <a href="#" class="menu--link" title="1:1 문의">
            ...
            <li class="menu--item">
                <a href="#" class="menu--link" title="고객 센터">
                    <i class="menu--icon fa-solid fa-headset"></i>
                    <span class="menu--label">고객 센터</span>
                </a>
            </li>
