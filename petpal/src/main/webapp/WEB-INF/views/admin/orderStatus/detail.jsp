		...
		<div class="mt-3 p-2">
			<table class="table table-bordered mb-1">
				...
				<tr>
					...
					<td class="text-primary"><fmt:formatNumber value="${order.usedPoint}"/></td>
				...
				<tbody>
					<c:forEach var="dto" items="${listDetail}" varStatus="status">
						<tr valign="middle" id="orderDetail-list${dto.orderDetailNum}">
							...
							<td><fmt:formatNumber value="${dto.priceOrig}"/></td>
							<td><fmt:formatNumber value="${dto.priceOrig - dto.discountAmount}"/></td>
							<td>
								<c:choose>
							...
							<td>${dto.amount}</td>
							<td><fmt:formatNumber value="${dto.pricePay}"/></td>
							...
							<td>
								<span class="orderDetailStatus-update" 
										...
										data-usedPoint="${order.usedPoint}"
										data-usedCoupon="${order.usedCoupon}"
										data-email="${order.email}"
										data-memberNum="${order.memberNum}"
										data-payment="${order.payment}"
										data-orderDate="${order.orderDate}"
										data-priceOrig="${dto.priceOrig}"
