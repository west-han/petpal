...
$(function(){
    $(document).on('click', '.btn-productStock', function(){
        // 재고 관리 대화상자
    ...
    $(document).on('click', '.btn-allStockUpdate', function(){
        ...
        let isValid = true;
        $('.productStock-list tr').each(function(){
        ...
        const fn = function(data) {
            ...
            $('#productStockDialogModal').modal('hide');
        };
...
<div class="modal fade" id="productStockDialogModal" tabindex="-1" aria-labelledby="productStockDialogModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body pt-1 modal-productStock">
                <!-- 재고 관리 내용이 여기에 로드됩니다. -->
            </div>
        </div>
    </div>
