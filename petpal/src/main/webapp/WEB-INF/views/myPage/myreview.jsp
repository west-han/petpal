        ...
        <div class="row">
            <div class="col-md-2">
				...
				<ul class="list-group">
					...
					<li class="list-group-item active"><a href="${pageContext.request.contextPath}/myPage/${species}/myreview">리뷰관리</a></li>
            ...
            <div class="col-md-9 ms-5">
                <h2>리뷰 관리</h2>
                <form action="${pageContext.request.contextPath}/myPage/${sessionScope.species}/myreview" method="get" name="searchForm2">
                ...
                <c:forEach var="review" items="${reviews}">
                    <div class="review-item">
                        <c:if test="${not empty review.thumbnail}">
                            <img src="${pageContext.request.contextPath}/uploads/product/${review.thumbnail}" alt="이미지">
                        </c:if>
