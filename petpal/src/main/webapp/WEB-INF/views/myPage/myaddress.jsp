        ...
        <div class="row">
            <div class="col-md-2">
				...
				<ul class="list-group">
					...
					<li class="list-group-item active"><a href="${pageContext.request.contextPath}/myPage/${species}/myaddress">나의 배송지</a></li>
                    ...
                    <c:forEach var="dto" items="${list}">
                        <div class="card address-item">
                            <div class="card-body">
                                ...
                                <form action="${pageContext.request.contextPath}/myPage/deleteAddress" method="post" style="display:inline;" >
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addAddressForm" name="addAddressForm" action="${pageContext.request.contextPath}/myPage/addAddress" method="post">
                        <div class="mb-3">
    ...
    <div class="modal fade" id="editAddressModal" tabindex="-1" aria-labelledby="editAddressModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editAddressForm" name="editAddressForm" action="${pageContext.request.contextPath}/myPage/updateAddress" method="post">
